    ...
    for CellChansTwo in range(1,(Channels+1)-channels_one):
        ...
        for CellChansThree in range(1,(Channels+1)-channels_one-channels_two):
            ...
            for CellChansFour in range(1,(Channels+1)-channels_one-channels_two-channels_three):
                ...
                BPA = BPAone*BPAtwo*BPAthree*BPAfour*BPAfive
                #combination 2
                ...
                BPBfour = BPAfour
                BPBfive = BPAfive
                BPB = BPBone*BPBtwo*BPBthree*BPBfour*BPBfive
                #combination 3
                BPCone = BPBone
                BPCtwo = BPBtwo
                BPCthree = BPAthree
                ...
                BPC = BPCone*BPCtwo*BPCthree*BPCfour*BPCfive
                #combination 4
                BPDone = BPAone
                BPDtwo = BPAtwo
                BPDthree = BPAthree
                BPDfour = BPCfour
                BPDfive = BPCfive
                BPD = BPDone*BPDtwo*BPDthree*BPDfour*BPDfive
